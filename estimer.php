...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO voitures (marque, modele, annee, kilometrage, carburant, boite_de_vitesse, prix_estimatif) 
            VALUES ('$marque', '$modele', $annee, $kilometrage, '$carburant', '$boite_de_vitesse', $prix_estimatif)";
